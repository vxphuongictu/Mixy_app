...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230120_vietnam_0d7d4fc540b299b64149_20230120173805_archive.zip';
        const ARCHIVE_SIZE       = '36766650';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '0d7d4fc-20173805';
        const SECONDARY_PACKAGE_HASH = '1fba1b1-20173805';
        const VERSION            = '1.5.1';
